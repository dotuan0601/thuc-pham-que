            ...
            <div class="contact">
                <div class="contact-form">
                    ...
                    <form method="post" action="contact-post.html">
                        <div>
                            <span><label class="control-label">Ảnh đại diện</label></span>
                            <input id="input-1" type="file" class="file">
                        </div>
                        <div>
                            <span><label>Tên hiển thị (*)</label></span>
                            <span><input name="userName" type="text" class="textbox"></span>
                        </div>
                        <div>
                            <span><label>Tên đầy đủ</label></span>
                            <span><input name="userFullName" type="text" class="textbox"></span>
                        </div>
                        <div>
                        ...
                        <div>
                            <span><label>Facebook</label></span>
                            <span><input name="userFacebook" type="text" class="textbox"></span>
                        </div>
                        <div>
                            <span><input type="submit" class="" value="Đăng ký"></span>
                        </div>
                    </form>
                </div>
                <div class="clear"></div>
